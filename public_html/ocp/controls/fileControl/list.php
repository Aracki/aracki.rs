...
<?php
	...
	$parameters = "root=".$root."&field=".$field."&sirina=".$sirina."&visina=".$visina."&max=".$max;
...
//echo("$mappedPutanja$file"."<br>");
					...
					if (checkExtension ($extensionFilter, $temp_ext) && utils_valid($temp_ext) && utils_valid($temp_name)){
						$fileNames[] = $temp_name;
...
?><FORM ACTION="list.php?<?php echo utils_randomQS();?>" METHOD="get" NAME="reconstructForm" ID="reconstructForm">
	...
	function preview(fileName){
		window.open("/ocp/controls/fileControl/preview.php?<?php echo utils_randomQS();?>&<?php echo $parameters?>&fileName="+fileName, "previewFrame");
	}
...
<div id="ocp_blok_menu_1">
  <table class="ocp_blokovi_table">
	...
	?><?php echo ocpLabels("Found files list")?>: <?php echo $strNav?></td>
	<form name="extensionFilterForm">
	<td class="ocp_blokovi_td" align="right">
		<select NAME="extensionFilter" class="ocp_forma" width="25" onChange="window.open('/ocp/controls/fileControl/list.php?<?php echo utils_randomQS();?>&<?php echo $parameters."&listType=".$listType."&putanja=".$putanja . "&sortType=". $sortType. "&sortField=".$sortField. "&extensionFilter="?>'+this.value, '_self')">
			<?php 
	...
	?><table class="ocp_opcije_table" id="listTable" name="listTable" style="width:100%">
		<tr id="trHeader" style="position:relative; top:0px">
		  ...
		  <td style="white-space: nowrap; margin: 0px; padding: 0px;">
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td class="ocp_opcije_td_header" style="white-space: nowrap; <?php if ($sortField == "names") { echo("border-bottom: 2px solid #C42E00;");}?>"><span class="ocp_opcije_tekst3"><?php echo ocpLabels("TITLE")?></span><img src="/ocp/img/blank.gif" width="3" border="0">
					<a href="/ocp/controls/fileControl/list.php?<?php echo utils_randomQS();?>&<?php echo $parameters . "&listType=" . $listType . "&putanja=" . $putanja  . "&extensionFilter=".$extensionFilter?>&sortType=D&sortField=names"><img border="0" height="7" src="/ocp/img/opsti/kontrole/strelica_filter_dole<?php if ($sortField == "names" && $sortType == "D") { echo("_select");}?>.gif" title="<?php echo ocpLabels("Sort")?>"></a><a href="/ocp/controls/fileControl/list.php?<?php echo utils_randomQS();?>&<?php echo $parameters . "&listType=" . $listType . "&putanja=" . $putanja  . "&extensionFilter=".$extensionFilter?>&sortType=A&sortField=names"><img border="0" height="7" src="/ocp/img/opsti/kontrole/strelica_filter_gore<?php if ($sortField == "names" && $sortType == "A") { echo("_select");}?>.gif" title="<?php echo ocpLabels("Sort")?>"></a></td>
				</tr>
			</table>
		  </td>
		  <td style="white-space: nowrap; margin: 0px; padding: 0px;">
			  <table width="100%" cellpadding="0" cellspacing="0">
					<tr>
						<td class="ocp_opcije_td_header" style="white-space: nowrap;<?php if ($sortField == "extensions") { echo("border-bottom: 2px solid #C42E00;");}?>"><span class="ocp_opcije_tekst3"><?php echo ocpLabels("EXTENSION")?></span><img src="/ocp/img/blank.gif" width="3" border="0">
						<a href="/ocp/controls/fileControl/list.php?<?php echo utils_randomQS();?>&<?php echo $parameters . "&listType=" . $listType . "&putanja=" . $putanja  . "&extensionFilter=".$extensionFilter?>&sortType=D&sortField=extensions"><img border="0" height="7" src="/ocp/img/opsti/kontrole/strelica_filter_dole<?php if ($sortField == "extensions" && $sortType == "D") { echo("_select");}?>.gif" title="<?php echo ocpLabels("Sort")?>"></a><a href="/ocp/controls/fileControl/list.php?<?php echo utils_randomQS();?>&<?php echo $parameters . "&listType=" . $listType . "&putanja=" . $putanja  . "&extensionFilter=".$extensionFilter?>&sortType=A&sortField=extensions"><img border="0" height="7" src="/ocp/img/opsti/kontrole/strelica_filter_gore<?php if ($sortField == "extensions" && $sortType == "A") { echo("_select");}?>.gif" title="<?php echo ocpLabels("Sort")?>"></a></td>
					</tr>
				</table>
		  </td>
		  <td style="white-space: nowrap; margin: 0px; padding: 0px;">
				<table width="100%" cellpadding="0" cellspacing="0">
					<tr>
						<td class="ocp_opcije_td_header" style="white-space: nowrap;<?php if ($sortField == "sizes") { echo("border-bottom: 2px solid #C42E00;");}?>"><span class="ocp_opcije_tekst3"><?php echo ocpLabels("SIZE")?></span><img src="/ocp/img/blank.gif" width="3" border="0">		  
						<a href="/ocp/controls/fileControl/list.php?<?php echo utils_randomQS();?>&<?php echo $parameters . "&listType=" . $listType . "&putanja=" . $putanja  . "&extensionFilter=".$extensionFilter?>&sortType=D&sortField=sizes"><img border="0" height="7" src="/ocp/img/opsti/kontrole/strelica_filter_dole<?php if ($sortField == "sizes" && $sortType == "D") { echo("_select");}?>.gif" title="<?php echo ocpLabels("Sort")?>"></a><a href="/ocp/controls/fileControl/list.php?<?php echo utils_randomQS();?>&<?php echo $parameters . "&listType=" . $listType . "&putanja=" . $putanja  . "&extensionFilter=".$extensionFilter?>&sortType=A&sortField=sizes"><img border="0" height="7" src="/ocp/img/opsti/kontrole/strelica_filter_gore<?php if ($sortField == "sizes" && $sortType == "A") { echo("_select");}?>.gif" title="<?php echo ocpLabels("Sort")?>"></a>
						</td>
					</tr>
				</table>
		  </td>
		  <td style="white-space: nowrap; margin: 0px; padding: 0px;">
			<table width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td class="ocp_opcije_td_header" style="white-space: nowrap;<?php if ($sortField == "dates") { echo("border-bottom: 2px solid #C42E00;");}?>"><span class="ocp_opcije_tekst3"><?php echo ocpLabels("DATE MODIFIED")?></span><img src="/ocp/img/blank.gif" width="3" border="0">		  
					<a href="/ocp/controls/fileControl/list.php?<?php echo utils_randomQS();?>&<?php echo $parameters . "&listType=" . $listType . "&putanja=" . $putanja  . "&extensionFilter=".$extensionFilter?>&sortType=D&sortField=dates"><img border="0" height="7" src="/ocp/img/opsti/kontrole/strelica_filter_dole<?php if ($sortField == "dates" && $sortType == "D") { echo("_select");}?>.gif" title="<?php echo ocpLabels("Sort")?>"></a><a href="/ocp/controls/fileControl/list.php?<?php echo utils_randomQS();?>&<?php echo $parameters . "&listType=" . $listType . "&putanja=" . $putanja  . "&extensionFilter=".$extensionFilter?>&sortType=A&sortField=dates"><img border="0" height="7" src="/ocp/img/opsti/kontrole/strelica_filter_gore<?php if ($sortField == "dates" && $sortType == "A") { echo("_select");}?>.gif" title="<?php echo ocpLabels("Sort")?>"></a>
					</td>
				</tr>
			</table>
		  </td>
		...
		<?php
			for ($i=($broj*$brojac); $i<min(($brojac+1)*$broj, $recordCount); $i++){
				...
				?><td class="ocp_opcije_td" width="20%" style="cursor:pointer;" onclick="preview('<?php echo $putanja.$fileNames[$i].".".$fileExtensions[$i]?>');"><table width="100%">
					...
					?>
									<img src="<?php echo $putanja.$fileNames[$i].".".$fileExtensions[$i]?>"  width="100" class="ocp_blokovi_ikona_velika">
									
					<?php
						} else if (ereg($fileExtensions[$i], $extensionGroups[2])) { 
					?>
									<img src="/ocp/img/kontrole/file_kontrola/<?php echo $fileExtensions[$i]?>.gif" class="ocp_blokovi_ikona_velika">
					<?php
					...
					<tr><td class="ocp_blokovi_td_tekst_3" align="center"><b><?php echo $fileNamesShort[$i].".".$fileExtensions[$i]?></b><br>
