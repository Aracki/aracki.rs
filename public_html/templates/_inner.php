	...
	<div class="container">
		...
		<?php if ($srpskeReci == 1) { ?>
			<form name="formPretraga" id="formPretraga" method="post" onSubmit="return validate();" action="#">
				...
				<div class="entry mid">
					<a href="<?php echo menu_getStraLink(menu_getVerzLabel("engsrp_id")); ?>"><!--img src="/gfx/strelice.png"/--></a>									
				</div>
				<div class="entry eng">
					<h2><img src="gfx/flagEN.png" alt="Srpski" /> <img src="gfx/engleski.png" alt="Srpski" /></h2>
