<?php 
	...
	$parameters = "root=".$root."&field=".$field."&sirina=".$sirina."&visina=".$visina."&max=".$max."&putanja=".$putanja;
	$loadDefaultPage = false;	//da li postoji default operacija

	$menuArray = array();

	$loadDefaultPage = true;
	$menuArray['lista_objekata'] = array(ocpLabels("List"), 'window.open("/ocp/controls/fileControl/list.php?'.utils_randomQS().'&listType=list&'.$parameters.'", "listFrame");');
	$menuArray['thumbs'] = array(ocpLabels("Thumbs"), 'window.open("/ocp/controls/fileControl/list.php?'.utils_randomQS().'&listType=thumbs&'.$parameters.'", "listFrame");');
	$menuArray['novi_fajl'] = array(ocpLabels("New file"),  'window.open("/ocp/controls/fileControl/upload.php?'.utils_randomQS().'&putanja='.$putanja.'", "uploadFrame");');
	$menuArray['novi_folder'] = array(ocpLabels("New folder"),  'window.open("/ocp/controls/fileControl/newfolder.php?'.utils_randomQS().'&putanja='.$putanja.'", "uploadFrame");');
