...
<script type="text/javascript">
    document.location='thumbs.php?file=<?php echo $file;?>';
</script>
    <?php
} else {
            ...
            <tr>
                <td>
                    ...
                    <form action="crop.php" method="post" onsubmit="return checkCoords();">
                        ...
                        <input type="button" value="<?php echo ocpLabels("Cancel"); ?>" onclick="document.location='thumbs.php?file=<?php echo $file;?>'" />
                    </form>
                </td>
                    <?php if ($dims[1] != 0) {
                        ?><td>
