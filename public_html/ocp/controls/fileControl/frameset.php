...
<script>
		...
		framesetStr += '<frame src="frameset_left.php?<?php echo utils_randomQS()?>&root=<?php echo $root?>&field=<?php echo $field?>&basicFolder=<?php echo $basicFolder?>&fileName=<?php echo $fileName?>&sirina=<?php echo $sirina?>&visina=<?php echo $visina?>&max=<?php echo $max?>" id="leftFrameset" name="leftFrameset" FRAMEBORDER="'+frameBorder+'" BORDER="5" scrolling="NO">';
		framesetStr += '<frame src="frameset_right.php?<?php echo utils_randomQS()?>&basicFolder=<?php echo $basicFolder?>&field=<?php echo $field?>&sirina=<?php echo $sirina?>&visina=<?php echo $visina?>&max=<?php echo $max?>&root=<?php echo $root?>" id="rightFrameset" name="rightFrameset" FRAMEBORDER="'+frameBorder+'" BORDER="5">';
