...
<SCRIPT>
	function openMenuInLowerFrame(type, id, typeR, idR, right, dubina, maxdubina, brojDeceR){
		window.open("/ocp/controls/imageControl/menu_frame.php?<?php echo utils_randomQS();?>&<?php echo $parameters?>&putanja=" + id, "menuFrame");
	}
...
<BODY class="ocp_body"><?php
	...
	$swfArgs .= "&treeSource=/ocp/controls/imageControl/left_data.php&treeFilter=".$root.",".$basicFolder;
