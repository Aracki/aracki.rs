<?php 
	...
	if (utils_valid($basicFolder)) {
		$frameSrc = "menu_frame.php?".utils_randomQS()."&listType=list&root=" . $root . "&field=" . $field . "&sirina=" . $sirina . "&visina=" . $visina . "&max=" . $max . "&putanja=" . $basicFolder;
	} else {
		$frameSrc = "menu_frame.php?".utils_randomQS()."&listType=list&root=" . $root . "&field=" . $field . "&sirina=" . $sirina . "&visina=" . $visina . "&max=" . $max . "&putanja=" . $root . "/";
	}
?><html>
<head>
<title>OCP</title>
